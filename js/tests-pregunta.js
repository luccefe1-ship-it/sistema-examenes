...
function generarHTMLResultados(resultados) {
    // VALIDACIÓN COMPLETA
    if (!resultados) {
        console.error('Resultados undefined');
        return '<div class="error">Error: No hay datos de resultados</div>';
    }
    
    if (!resultados.test) {
        console.error('resultados.test es null o undefined', resultados);
        return '<div class="error">Error: Datos del test incompletos</div>';
    }
